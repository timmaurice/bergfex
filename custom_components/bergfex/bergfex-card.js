      ...
      <ha-card .header=${this._config.title} tabindex="0">
        <div class="card-content">
          ${t.map(([t,e])=>{const s=e.status;if(!s)return W`
              ...
              `;const i=this.hass.devices[t],o=e.name||i?.name_by_user||i?.name||"Unknown Resort",n=e.operation_status?this.hass.states[e.operation_status]:void 0,a=e.status?this.hass.states[e.status]:void 0,r=a?.state??"unknown",l=r,c=this._statusBadge(r,a?.attributes??{}),d=xt(this.hass,`component.bergfex-card.card.status.${c.key}`)||l,h=a?.attributes.link,p=e.snow_valley?this.hass.states[e.snow_valley]:void 0,_=e.snow_mountain?this.hass.states[e.snow_mountain]:void 0,u=e.new_snow?this.hass.states[e.new_snow]:void 0,f=e.lifts_open_count?this.hass.states[e.lifts_open_count]:void 0,m=f||(e.lifts_open?this.hass.states[e.lifts_open]:void 0),g=e.last_update?this.hass.states[e.last_update]:void 0,v=At(g?.state),y=e.snow_condition?this.hass.states[e.snow_condition]:void 0,w=e.slope_condition?this.hass.states[e.slope_condition]:void 0,$=e.last_snowfall?this.hass.states[e.last_snowfall]:void 0,b=e.avalanche_warning?this.hass.states[e.avalanche_warning]:void 0,k=e.slopes_open_km?this.hass.states[e.slopes_open_km]:void 0,x=e.slopes_open_count?this.hass.states[e.slopes_open_count]:void 0,S=x||(e.slopes_open?this.hass.states[e.slopes_open]:void 0),A=e.classical_trails_open?this.hass.states[e.classical_trails_open]:void 0,N=e.skating_trails_open?this.hass.states[e.skating_trails_open]:void 0,C=e.classical_condition?this.hass.states[e.classical_condition]:void 0,E=e.skating_condition?this.hass.states[e.skating_condition]:void 0,P=this._isCrossCountryResort(e),T=A?.attributes?.total,M=N?.attributes?.total,O=m?.attributes?.total,z=k?.attributes?.total,j=S?.attributes?.total,R=this._accordionState[t]?.conditions??this._config.conditions_default_open,U=this._accordionState[t]?.forecast??this._config.forecast_default_open;return W`
              <div class="resort" tabindex="0" @click=${()=>this._handleMoreInfo(s)}>
                  ...
                  ${P?W`
                          ...
                          ${N?W`
                                  ...
                                  >
                                    ...
                                    <div class="detail-item-value">
                                      ${N&&!isNaN(parseFloat(N.state))?(()=>{const t=parseFloat(N.state),e=N.attributes.unit_of_measurement??"km",s=M?parseFloat(String(M)):NaN;return isNaN(s)?W`<div class="value-row">
                                                <span>${N.state} ${e}</span>
                                ...
                                `:""}
                        `:W`
                          ${this._config.show_lifts_slopes&&m?W`
                                  <div
                                    class=${vt({"detail-item":!0,"n-a":!m||isNaN(parseFloat(m.state))})}
                                    @click=${t=>{t.stopPropagation(),m&&this._handleMoreInfo(m.entity_id)}}
                                  >
                                    <ha-icon icon="mdi:gondola"></ha-icon>
                                    <div class="detail-item-value">
                                      ${m&&!isNaN(parseFloat(m.state))?(()=>{const t=parseFloat(m.state),e=O?parseFloat(String(O)):NaN;return isNaN(e)?W`<div class="value-row">
                                                <span>${m.state}</span>
                                ...
                                `:""}
                          ${this._config.show_lifts_slopes&&(k||S)?W`
                                  ${k?W`
                                          <div
                                          ...
                                          >
                                            ...
                                            <div class="detail-item-value">
                                              ${k&&!isNaN(parseFloat(k.state))?(()=>{const t=parseFloat(k.state),e=z?parseFloat(String(z)):NaN,s=k.attributes.unit_of_measurement??"km";return isNaN(e)?W`<div class="value-row">
                                                        <span>${k.state} ${s}</span>
                                  ...
                                  ${S&&j?W`
                                          <div
                                            class=${vt({"detail-item":!0,"n-a":!S||isNaN(parseFloat(S.state))||isNaN(parseFloat(String(j??NaN)))})}
                                            @click=${t=>{t.stopPropagation(),S&&this._handleMoreInfo(S.entity_id)}}
                                          >
                                            <ha-icon icon="mdi:counter"></ha-icon>
                                            <div class="detail-item-value">
                                              ${S&&!isNaN(parseFloat(S.state))?(()=>{const t=parseFloat(S.state),e=j?parseFloat(String(j)):NaN;return isNaN(e)?W`<div class="value-row">
                                                        <span>${S.state}</span>
                                        ...
                                        `:S?W`
                                            ...
                                            >
                                              <ha-icon icon="mdi:counter"></ha-icon>
                                              <div class="detail-item-value">
                                                ${S&&!isNaN(parseFloat(S.state))?W`<div class="value-row">
                                                        <span>${S.state}</span>
                                                        ${this._renderTrend(S.entity_id,S.state)}
                                                      </div>`:W`<span>N/A</span>`}
                                                <span class="detail-item-label"
                ...
                ${this._config.show_conditions&&(y||w||b||$||n||C||E)?W`
                        <div class="accordion-container">
                          ...
                          ${R?W`
                                  <div class="accordion-content details">
                                    ${this._config.show_conditions&&(y||w)&&!P?W`
                                            ${y?W`
                                                    <div
                                            ...
                                            ${w?W`
                                                  ...
                                                  `:""}
                                          `:""}
                                    ${this._config.show_conditions&&b&&!P?W`
                                            <div
                                          ...
                                          `:""}
                                    ${this._config.show_conditions&&(C||E)?W`
                                            ${C?W`
                                                    <div
...
function(t){return(e,s,i)=>((t,e,s)=>(s.configurable=!0,s.enumerable=!0,Reflect.decorate&&"object"!=typeof e&&Object.defineProperty(t,e,s),s))(e,s,{get(){return(e=>e.renderRoot?.querySelector(t)??null)(this)}})}("ha-card")],Ot.prototype,"_card",void 0),t([_t()],Ot.prototype,"_config",void 0),t([_t()],Ot.prototype,"_forecastState",void 0),t([_t()],Ot.prototype,"_accordionState",void 0),t([_t()],Ot.prototype,"_historyState",void 0),customElements.get(Tt)?console.warn(`${Tt}: another copy of this card is already loaded, so this one stays inactive. The card now ships with the Bergfex integration - uninstall "Bergfex Card" from HACS and reload your browser.`):customElements.define(Tt,Ot),"undefined"!=typeof window&&(window.customCards=window.customCards||[],window.customCards.some(t=>t.type===Tt)||window.customCards.push({type:Tt,name:"Bergfex Card",description:"A Lovelace card to display ski resort conditions from Bergfex.",documentationURL:"https://github.com/timmaurice/bergfex",getEntitySuggestion:(t,e)=>{const s=t.entities[e];return"bergfex"===s?.platform&&s.device_id?{config:{type:`custom:${Tt}`,resorts:[s.device_id]}}:null}}));const zt=r`.card-config{display:flex;flex-direction:column;gap:12px}.group{border:1px solid var(--divider-color);border-radius:var(--ha-card-border-radius, 12px);margin-top:0;padding:16px}.group-header{color:var(--primary-text-color);font-size:16px;font-weight:500;margin-bottom:12px}ha-form{display:block}`;function jt(t){return"string"==typeof t?t:t.device}const Rt=[{name:"title",selector:{text:{}}},{name:"resorts",selector:{device:{multiple:!0,integration:"bergfex"}}},{type:"expandable",title:"groups.display",schema:[{name:"show_conditions",selector:{boolean:{}}},{name:"conditions_default_open",selector:{boolean:{}}},{name:"show_trend",selector:{boolean:{}}},{name:"show_link",selector:{boolean:{}}},{name:"show_last_updated",selector:{boolean:{}}},{name:"hide_closed_resorts",selector:{boolean:{}}},{name:"sort_by",selector:{select:{mode:"dropdown"}}}]},{type:"expandable",title:"groups.ski_only",schema:[{name:"show_snow",selector:{boolean:{}}},{name:"show_lifts_slopes",selector:{boolean:{}}},{name:"show_forecast",selector:{boolean:{}}},{name:"forecast_default_open",selector:{boolean:{}}}]}],Ut="bergfex-card-editor";class Ft extends lt{setConfig(t){this._config={show_snow:!0,show_lifts_slopes:!0,show_conditions:!0,show_forecast:!1,show_trend:!1,conditions_default_open:!1,forecast_default_open:!1,...t}}_valueChanged(t){if(!this.hass||!this._config)return;const e={...t.detail.value};if(Array.isArray(e.resorts)){const t=new Map;for(const e of this._config.resorts??[])e&&"object"==typeof e&&e.name&&t.set(e.device,e.name);e.resorts=e.resorts.filter(Boolean).map(e=>{const s=jt(e),i=t.get(s);return i?{device:s,name:i}:s})}St(this,"config-changed",{config:{...this._config,...e}})}render(){if(!this.hass||!this._config)return W``;const t=[{value:"mountain",label:xt(this.hass,"component.bergfex-card.editor.sort_by_options.mountain")},{value:"valley",label:xt(this.hass,"component.bergfex-card.editor.sort_by_options.valley")},{value:"new",label:xt(this.hass,"component.bergfex-card.editor.sort_by_options.new")},{value:"lift",label:xt(this.hass,"component.bergfex-card.editor.sort_by_options.lift")},{value:"classical",label:xt(this.hass,"component.bergfex-card.editor.sort_by_options.classical")},{value:"skating",label:xt(this.hass,"component.bergfex-card.editor.sort_by_options.skating")},{value:"update",label:xt(this.hass,"component.bergfex-card.editor.sort_by_options.update")}],e=(e=>e.reduce((e,s)=>{const i={...s};if("expandable"===i.type&&Array.isArray(i.schema)){const s=i.schema.map(t=>({...t}));return"groups.display"===i.title&&s.forEach(e=>{"sort_by"===e.name&&(e.selector={select:{mode:"dropdown",clearable:!0,options:t}})}),i.title="string"==typeof i.title?xt(this.hass,`component.bergfex-card.editor.${i.title}`):i.title,i.schema=s,e.push(i),e}return"resorts"===i.name&&(i.selector={device:{multiple:!0,integration:"bergfex"}}),e.push(i),e},[]))(Rt),s={...this._config,resorts:(this._config.resorts??[]).filter(Boolean).map(jt)};return W`
    ...
    `}static{this.styles=r`
    ${a(zt)}
  `}}t([pt({attribute:!1})],Ft.prototype,"hass",void 0),t([_t()],Ft.prototype,"_config",void 0),customElements.get(Ut)||customElements.define(Ut,Ft);var Lt=Object.freeze({__proto__:null,BergfexCardEditor:Ft});export{Ot as BergfexCard};
