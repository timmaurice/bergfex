...
function(t){return(e,s,i)=>((t,e,s)=>(s.configurable=!0,s.enumerable=!0,Reflect.decorate&&"object"!=typeof e&&Object.defineProperty(t,e,s),s))(e,s,{get(){return(e=>e.renderRoot?.querySelector(t)??null)(this)}})}("ha-card")],Ot.prototype,"_card",void 0),t([_t()],Ot.prototype,"_config",void 0),t([_t()],Ot.prototype,"_forecastState",void 0),t([_t()],Ot.prototype,"_accordionState",void 0),t([_t()],Ot.prototype,"_historyState",void 0),customElements.get(Tt)?console.warn(`${Tt}: another copy of this card is already loaded, so this one stays inactive. The card now ships with the Bergfex integration - uninstall "Bergfex Card" from HACS and reload your browser.`):customElements.define(Tt,Ot),"undefined"!=typeof window&&(window.customCards=window.customCards||[],window.customCards.some(t=>t.type===Tt)||window.customCards.push({type:Tt,name:"Bergfex Card",description:"A Lovelace card to display ski resort conditions from Bergfex.",documentationURL:"https://github.com/timmaurice/bergfex",getEntitySuggestion:(t,e)=>{const s=t.entities[e];return"bergfex"===s?.platform&&s.device_id?{config:{type:`custom:${Tt}`,resorts:[s.device_id]}}:null}}));const zt=r`.card-config{display:flex;flex-direction:column;gap:12px}.group{border:1px solid var(--divider-color);border-radius:var(--ha-card-border-radius, 12px);margin-top:0;padding:16px}.group-header{color:var(--primary-text-color);font-size:16px;font-weight:500;margin-bottom:12px}ha-form{display:block}`;function jt(t){return"string"==typeof t?t:t.device}const Rt=[{name:"title",selector:{text:{}}},{name:"resorts",selector:{device:{multiple:!0,integration:"bergfex"}}},{type:"expandable",title:"groups.display",schema:[{name:"show_conditions",selector:{boolean:{}}},{name:"conditions_default_open",selector:{boolean:{}}},{name:"show_trend",selector:{boolean:{}}},{name:"show_link",selector:{boolean:{}}},{name:"show_last_updated",selector:{boolean:{}}},{name:"hide_closed_resorts",selector:{boolean:{}}},{name:"sort_by",selector:{select:{mode:"dropdown"}}}]},{type:"expandable",title:"groups.ski_only",schema:[{name:"show_snow",selector:{boolean:{}}},{name:"show_lifts_slopes",selector:{boolean:{}}},{name:"show_forecast",selector:{boolean:{}}},{name:"forecast_default_open",selector:{boolean:{}}}]}],Dt="bergfex-card-editor";class Ut extends lt{setConfig(t){this._config={show_snow:!0,show_lifts_slopes:!0,show_conditions:!0,show_forecast:!1,show_trend:!1,conditions_default_open:!1,forecast_default_open:!1,...t}}_valueChanged(t){if(!this.hass||!this._config)return;const e={...t.detail.value};if(Array.isArray(e.resorts)){const t=new Map;for(const e of this._config.resorts??[])e&&"object"==typeof e&&e.name&&t.set(e.device,e.name);e.resorts=e.resorts.filter(Boolean).map(e=>{const s=jt(e),i=t.get(s);return i?{device:s,name:i}:s})}St(this,"config-changed",{config:{...this._config,...e}})}render(){if(!this.hass||!this._config)return W``;const t=[{value:"mountain",label:xt(this.hass,"component.bergfex-card.editor.sort_by_options.mountain")},{value:"valley",label:xt(this.hass,"component.bergfex-card.editor.sort_by_options.valley")},{value:"new",label:xt(this.hass,"component.bergfex-card.editor.sort_by_options.new")},{value:"lift",label:xt(this.hass,"component.bergfex-card.editor.sort_by_options.lift")},{value:"classical",label:xt(this.hass,"component.bergfex-card.editor.sort_by_options.classical")},{value:"skating",label:xt(this.hass,"component.bergfex-card.editor.sort_by_options.skating")},{value:"update",label:xt(this.hass,"component.bergfex-card.editor.sort_by_options.update")}],e=(e=>e.reduce((e,s)=>{const i={...s};if("expandable"===i.type&&Array.isArray(i.schema)){const s=i.schema.map(t=>({...t}));return"groups.display"===i.title&&s.forEach(e=>{"sort_by"===e.name&&(e.selector={select:{mode:"dropdown",clearable:!0,options:t}})}),i.title="string"==typeof i.title?xt(this.hass,`component.bergfex-card.editor.${i.title}`):i.title,i.schema=s,e.push(i),e}return"resorts"===i.name&&(i.selector={device:{multiple:!0,integration:"bergfex"}}),e.push(i),e},[]))(Rt),s={...this._config,resorts:(this._config.resorts??[]).filter(Boolean).map(jt)};return W`
    ...
    `}static{this.styles=r`
    ${a(zt)}
  `}}t([pt({attribute:!1})],Ut.prototype,"hass",void 0),t([_t()],Ut.prototype,"_config",void 0),customElements.get(Dt)||customElements.define(Dt,Ut);var Ft=Object.freeze({__proto__:null,BergfexCardEditor:Ut});export{Ot as BergfexCard};
