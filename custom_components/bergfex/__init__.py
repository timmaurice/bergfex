...
type BergfexConfigEntry = ConfigEntry[DataUpdateCoordinator[dict[str, dict[str, Any]]]]
...
async def async_setup_entry(hass: HomeAssistant, entry: BergfexConfigEntry) -> bool:
    ...
    # Always create a resort-specific coordinator to get detail page data. It
    # belongs to this entry alone: a second entry for the same resort used to
    # borrow the first one's, and unloading the first shut it down under both.
